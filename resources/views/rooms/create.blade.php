...
@section('content')
    <style>
        /* Style đồng bộ với Invoices và Contracts */
        ...
        .img-preview {
            ...
            display: none; margin: 10px auto; border: 1px solid #ddd; object-fit: cover;
        }
