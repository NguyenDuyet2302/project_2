...
@section('content')
    ...
    {{-- Bảng dữ liệu - Bỏ border đen, dùng style hiện đại giống Room --}}
    ...
    {{-- PHẦN PHÂN TRANG (PAGINATION) - Logic ẩn nút trang trước/sau --}}
    <div style="margin-top: 25px; display: flex; justify-content: center; gap: 15px; align-items: center;">

        {{-- Hiện nút Trang trước nếu không phải trang 1 --}}
        ...
        {{-- Hiện nút Trang sau nếu còn dữ liệu --}}
